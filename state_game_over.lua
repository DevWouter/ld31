...
GameOverState = GameState.new_type()

function GameOverState:on_start(game)
  self.game = game
  -- Load background
...
function GameOverState:draw_button(text, x, y, w, h)
  local hsw = 683/2;
...
function GameOverState:draw()
  ...
  love.graphics.print("You are death, congrats!")
